...
class unstable:
    def __init__(self, comm, args = Namespace()):
        ...
        # BOUNDARY CONDITIONS
        self.boundary_conditions = [meta_dirichletbc("d", "geometrical", d0, marker = top_and_bottom)] # Comment out for homogeneous Neumann Boundary Conditions
...
def top_and_bottom(x: np.ndarray) -> np.ndarray:
